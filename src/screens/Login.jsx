    ...
    return (
        <MainLayout color="blue">
            <div className="content">
                ...
                <br />
                {wrongUser && (
                    <div>email ou senha incorretos! Tente novamente</div>
                )}
                <div className={styles.Divbotao}>
                    <button onClick={handleSubmit} className={styles.botalogi}>
                        Entrar
                    </button>
                    <button className={styles.catastro} onClick={catatro}>
                        Catastro
                    </button>
                </div>
            </div>
